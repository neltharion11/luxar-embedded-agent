...
You are LUXAR 0.2.3 operating inside project '{project}'.
...
def inject_project_metadata(base_prompt: str, project: str, cm: ConfigManager) -> str:
    ...
    if project:
        ...
        # Inject platform-specific development rules (base), then runtime extension if freertos
