...
class ProjectManager:
    ...
    def create_project(
        ...
        was_new_dir = not project_dir.exists()
        try:
            project_dir.mkdir(parents=True, exist_ok=True)

            if project_mode != "cubemx":
                ...
                # CubeMX: create only LUXAR-owned user-code directories.
                # Core/Drivers/CMake/toolchain files are generated by CubeMX.
                for rel_dir in ("App", "App/Inc", "App/Src", "BSP"):
                    (project_dir / rel_dir).mkdir(parents=True, exist_ok=True)
            ...
            if was_new_dir and project_dir.exists():
                import shutil
        ...
        if metadata_file.exists():
            ...
            config = loaded.model_copy(
                update={
                    ...
                    "family": loaded.family or family,
                    "device_define": loaded.device_define or device_define,
                }
            )
        else:
