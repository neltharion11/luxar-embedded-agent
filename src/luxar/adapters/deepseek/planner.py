...
class DeepSeekPlanner:
    ...
    def create_plan(
        ...
        system_prompt = (
            ...
            "如果 project_analysis.project_exists 为 false，计划必须以 create_project 开始；"
            "如果项目已存在，禁止生成 create_project。"
            ...
            "对不会阻止实现、但用户可能在意的模糊配置（例如 I2C 速率、上拉方式、"
            "采样周期），写入 clarifications，并给出安全默认值、选项和原因；"
            "不得把这类可选项伪装成阻塞字段。"
